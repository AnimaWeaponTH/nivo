(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(
        ...
        require('prop-types'),
        require('d3-shape'),
        require('recompose/setDisplayName'),
        require('recompose/compose'),
        require('recompose/pure'),
        require('recompose/defaultProps'),
        require('recompose/withPropsOnChange'),
        require('@nivo/core'),
        require('@nivo/colors'),
        require('@nivo/legends'),
        require('@nivo/tooltip'),
        require('lodash/get'),
      )
    ...
    : ((global = global || self),
      factory(
        (global.nivo = global.nivo || {}),
        global.React,
        global.PropTypes,
        global.d3,
        global.RecomposeSetDisplayName,
        global.RecomposeCompose,
        global.RecomposePure,
        global.RecomposeDefaultProps,
        global.RecomposeWithPropsOnChange,
        global.nivo,
        global.nivo,
        global.nivo,
        global.nivo,
  ...
  PropTypes =
    PropTypes && PropTypes.hasOwnProperty('default')
      ...
      : PropTypes;
  setDisplayName =
    setDisplayName && setDisplayName.hasOwnProperty('default')
      ? setDisplayName['default']
      : setDisplayName;
  compose =
    compose && compose.hasOwnProperty('default') ? compose['default'] : compose;
  pure = pure && pure.hasOwnProperty('default') ? pure['default'] : pure;
  defaultProps =
    defaultProps && defaultProps.hasOwnProperty('default')
      ? defaultProps['default']
      : defaultProps;
  withPropsOnChange =
    withPropsOnChange && withPropsOnChange.hasOwnProperty('default')
      ? withPropsOnChange['default']
      : withPropsOnChange;
    ...
    return compose(
      ...
      withPropsOnChange(
        ...
        function(_ref2) {
          ...
          var boundingBox;
          if (fit === true) {
            var _computeArcBoundingBo = core.computeArcBoundingBox(
                centerX,
                centerY,
                radius,
                startAngle - 90,
            ...
            centerX =
              ((centerX - box.x) / box.width) * box.width * ratio +
              adjustedBox.x;
            centerY =
      ...
      withPropsOnChange(
        ...
        function(_ref3) {
          ...
          var pie = d3Shape
            ...
            .startAngle(core.degreesToRadians(startAngle))
            .endAngle(core.degreesToRadians(endAngle));
  ...
  var PieSlice = function PieSlice(_ref) {
    ...
    var handleTooltip = function handleTooltip(e) {
      return showTooltip(
        React__default.createElement(tooltip.BasicTooltip, {
          id: data.label,
          value: data.value,
          enableChip: true,
          color: color,
  ...
  var computeRadialLabels = function computeRadialLabels(arcs, _ref) {
    ...
    return arcs
      ...
      .map(function(arc) {
        ...
        var positionB = core.positionFromAngle(
          angle,
        ...
        var textAlign;
        if (
          core.absoluteAngleDegrees(core.radiansToDegrees(angle)) < 90 ||
          core.absoluteAngleDegrees(core.radiansToDegrees(angle)) >= 270
        ) {
          positionC = {
        ...
        value: function render() {
          var _this$props = this.props,
            ...
            radialLabelsLinkStrokeWidth =
              _this$props.radialLabelsLinkStrokeWidth,
          ...
          var borderColor = colors.getInheritedColorGenerator(
            _borderColor,
            theme,
          );
          return React__default.createElement(
                ...
                function(_ref2) {
                  ...
                  return React__default.createElement(
                    ...
                    React__default.createElement(
                      ...
                      enableRadialLabels &&
                        React__default.createElement(PieRadialLabels, {
                          arcs: arcs,
                          radius: radius,
                          ...
                          textColor: colors.getInheritedColorGenerator(
                            radialLabelsTextColor,
                            theme,
                          ),
                          linkColor: colors.getInheritedColorGenerator(
                            radialLabelsLinkColor,
                            theme,
                          ),
                          theme: theme,
                      ...
                      enableSlicesLabels &&
                        React__default.createElement(PieSlicesLabels, {
                          arcs: arcs,
                          radius: radius,
                          innerRadius: innerRadius,
                          theme: theme,
  ...
  var ResponsivePie = function ResponsivePie(props) {
    return React__default.createElement(core.ResponsiveWrapper, null, function(
      _ref,
    ) {
      ...
      _defineProperty$8(
        ...
        function(showTooltip, hideTooltip) {
          return function(event) {
            ...
            if (arc) {
              showTooltip(
                React__default.createElement(PieTooltip$1, {
                  data: arc.data,
                  color: arc.color,
                  theme: _this.props.theme,
                }),
    ...
    _createClass$5(PieCanvasRenderer, [
      ...
      },
      {
        ...
        value: function draw(props) {
          ...
          var getBorderColor = colors.getInheritedColorGenerator(
            borderColor,
            theme,
          );
          ...
          if (enableSlicesLabels === true) {
            ...
            drawSliceLabels(this.ctx, arcs, {
              ...
              getTextColor: colors.getInheritedColorGenerator(
                slicesLabelsTextColor,
                theme,
              ),
              theme: theme,
          ...
          if (enableRadialLabels === true) {
            ...
            drawRadialLabels(this.ctx, arcs, {
              ...
              getLinkColor: colors.getInheritedColorGenerator(
                radialLabelsLinkColor,
                theme,
              ),
              theme: theme,
  ...
  var usePie = function usePie(_ref) {
    ...
    var arcGenerator = React.useMemo(
      function() {
        return d3Shape
          .arc()
          .outerRadius(radius)
    ...
    var pie = React.useMemo(
      function() {
        var computedPie = d3Shape
          .pie()
          .value(getValue)
          .padAngle(core.degreesToRadians(padAngle))
          .startAngle(core.degreesToRadians(startAngle))
