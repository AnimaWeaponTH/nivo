...
const props = [
    ...
    {
        key: 'radialLabelsDisableOverlap',
        help: 'Enable/disable to fix overlapping label text.',
        type: 'boolean',
        required: false,
        defaultValue: false,
        controlType: 'switch',
    ...
    {
        key: 'radialLabelsTextWidth',
        help: 'Label text width.',
        type: 'number',
        required: false,
        defaultValue: 100,
        controlType: 'range',
    ...
    {
        key: 'radialLabelsTextHeight',
        help: 'Label text height.',
        type: 'number',
        required: false,
        defaultValue: 25,
        controlType: 'range',
